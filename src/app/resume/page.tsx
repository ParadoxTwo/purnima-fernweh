...
const skillsData = [
  {
    title: 'Childcare',
    description:
      'Patient, attentive, and creative with activities; skilled in ensuring safety and comfort for children.',
  },
  {
    title: 'Cleaning',
    description:
      'Detail-oriented with a strong commitment to cleanliness and organization; familiar with basic cleaning tools and techniques.',
  },
  {
    title: 'Cooking',
    description:
      'Experienced with preparing simple, nutritious meals; knowledgeable in basic kitchen hygiene and food safety practices.',
  },
];
...
const summaryContent =
  'Reliable and motivated individual eager to start a career in childcare, cleaning, and cooking. Known for being caring, detail-oriented, and organized, with a strong interest in supporting families by providing a safe and comfortable environment. Quick to learn new skills and dedicated to maintaining high standards in all tasks.';
