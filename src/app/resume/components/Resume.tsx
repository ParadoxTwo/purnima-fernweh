        ...
        <Container>
            ...
            <MainContent>
                ...
                <Section as={Element} name="summary">
                    <ProfessionalSummary title="Professional Summary" content={summaryContent} />
                </Section>
                ...
                <Section as={Element} name="education">
                    <EducationCertifications title="Education & Certifications" items={educationItems} />
                </Section>
            </MainContent>
        </Container>
    );
...
const ProfileStart = styled.div`padding-top: 40px;`;
