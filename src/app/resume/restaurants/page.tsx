...
const skillsData = [
    { title: "Food Preparation", description: "Skilled in preparing a variety of Indian dishes with authentic flavors and techniques." },
    { title: "Customer Service", description: "Friendly and attentive, ensuring a positive dining experience for all customers." },
    { title: "Time Management", description: "Able to manage multiple orders efficiently while maintaining quality." },
    { title: "Adaptability", description: "Quick to adapt to new recipes, customer preferences, and kitchen environments." },
    { title: "Large-Scale Cooking", description: "Experienced in preparing meals for large number of people while maintaining quality and efficiency." }
];
...
const summaryContent = "Friendly and organized individual with a passion for food preparation and customer service. Experienced in preparing simple, nutritious meals and maintaining cleanliness in food preparation areas. Skilled in cooking for large groups of people, ensuring high standards of hygiene, quality, and customer satisfaction. Quick to learn, reliable, and committed to excellence in a café or restaurant environment.";
