...
const skillsData = [
    { title: "Childcare", description: "Patient, attentive, and creative with activities, focusing on children’s safety and comfort." },
    { title: "Organizational Skills", description: "Efficient in planning and managing routines, ensuring smooth and enjoyable experiences for children." },
    { title: "Activity Planning", description: "Capable of organizing age-appropriate activities that engage and entertain." },
    { title: "Trustworthy and Reliable", description: "Built strong relationships with families, becoming a trusted presence." }
];
