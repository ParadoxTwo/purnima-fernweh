...
const skillsData = [
  {
    ...
    description:
      'Strong attention to detail and commitment to cleanliness in all areas.',
  },
  {
    title: 'Organization',
    description: 'Skilled in organizing spaces for maximum tidiness and order.',
  },
  {
    title: 'Knowledge of Cleaning Tools',
    description:
      'Experienced with a variety of cleaning tools and products for effective results.',
  },
  {
    title: 'Reliability and Efficiency',
    description:
      'Dependable, with a proven ability to complete tasks thoroughly and efficiently.',
  },
];
