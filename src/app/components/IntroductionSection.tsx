  ...
  return (
    ...
    >
      <DescriptionContainer>
        <Description style={{ y, opacity }}>
          I am Purnima Fernweh and for me, fashion is not just about style, but
          a reflection of God&apos;s grace and the beauty of His creation.
        </Description>
      </DescriptionContainer>
